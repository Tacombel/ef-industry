...
INSERT INTO "new_Item" ("createdAt", "id", "isAsteroid", "isFinalProduct", "isFound", "isRawMaterial", "name", "typeId", "updatedAt", "volume") SELECT "createdAt", "id", "isAsteroid", "isFinalProduct", "isFound", "isRawMaterial", "name", "typeId", "updatedAt", "volume" FROM "Item";
DROP TABLE "Item";
