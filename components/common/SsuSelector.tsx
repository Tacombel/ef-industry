  ...
  return (
    <div className="rounded-lg border border-gray-800 bg-gray-900/50 px-3 py-2 space-y-1.5">
      <div className="flex items-center justify-between">
        <span className="text-xs text-gray-500 font-medium uppercase tracking-wide">Stock SSU</span>
        <span className="text-xs text-gray-600">{activeCount} de {ssus.length} activos</span>
      </div>
        ...
        {ssus.map((ssu) => {
          ...
          return (
            <label
              ...
              title={offline ? (included ? "OFFLINE — excluir al volver online" : "OFFLINE — incluir al volver online") : (included ? "Excluir del cálculo" : "Incluir en el cálculo")}
            >
              <button
                type="button"
